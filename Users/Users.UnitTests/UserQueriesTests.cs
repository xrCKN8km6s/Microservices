...
public class UserQueriesTests
{
    ...
    public async Task UserQueries_GetRolesViewModelAsync_ReturnEmptyRolesWhenNoRolesInDB()
    {
        var options = new DbContextOptionsBuilder<UsersContext>()
            .UseInMemoryDatabase(
                databaseName: nameof(UserQueries_GetRolesViewModelAsync_ReturnEmptyRolesWhenNoRolesInDB))
            .Options;
    ...
    public async Task UserQueries_GetRolesViewModelAsync_IgnoresRolesWithIsActiveFalse()
    {
        var options = new DbContextOptionsBuilder<UsersContext>()
            .UseInMemoryDatabase(
                databaseName: nameof(UserQueries_GetRolesViewModelAsync_IgnoresRolesWithIsActiveFalse))
            .Options;
